            ...
            */}
            ...
            >
              ...
              <div className={clsx('relative', 'w-full')}>
                <LabelField id="full-name" text="Full Name" />
                <SingleLineField
                  id="full-name"
                  type="text"
              ...
              <div className={clsx('relative', 'w-full')}>
                ...
                />
                <ul
                  className={clsx('text-[#C4C6D0] text-sm', 'mt-2 space-y-1')}
              ...
              <div className={clsx('relative', 'w-full')}>
                <LabelField id="confirm-password" text="Confirm Password" />
                <SingleLineField
                  id="confirm-password"
                  type="password"
              ...
              <div className={clsx('flex items-start gap-2')}>
                <p className={clsx('leading-relaxed', 'w-full')}>
                  <InputCheckbox
                    id="agree-terms"
            ...
            {/* Login */}
            <div className={clsx('text-center', 'mt-14')}>
