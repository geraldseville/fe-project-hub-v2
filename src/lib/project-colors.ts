...
function colorToOklch(color: string) {
...
export function generateProjectColors(primaryColor: string): ProjectColors {
  const primaryOklch = colorToOklch(primaryColor);
